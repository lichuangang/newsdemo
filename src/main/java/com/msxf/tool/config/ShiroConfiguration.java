...
import com.msxf.tool.shiro.MyShiroRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        //配置不需要登录访问的页面
        filterChainDefinitionMap.put("/captcha.jpg", "anon");//验证码不需要验证
        filterChainDefinitionMap.put("/login", "anon");//登录
        filterChainDefinitionMap.put("/login.html", "anon");//登录
        filterChainDefinitionMap.put("/public/**", "anon");//登录
        //配置记住我或认证通过可以访问的地址
    ...
    public MyShiroRealm myShiroRealm() {
        ...
        //myShiroRealm.setCredentiavc   lsMatcher(hashedCredentialsMatcher());
        return myShiroRealm;
    }
