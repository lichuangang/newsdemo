...
public class DataTypeUtils {
    ...
    public static Float getFloatValue(Object value) {
        return value == null ? null : (value instanceof Float ? Float.valueOf(((Float) value).floatValue()) : (value instanceof Long ? (Long) value : (value instanceof Double ? Long.valueOf(((Double) value).longValue()) : (value instanceof BigDecimal ? Long.valueOf(((BigDecimal) value).longValue()) : Long.valueOf(value.toString())))));
    }
